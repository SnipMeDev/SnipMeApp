...
object Bridge {
    ...
    val BridgePigeonMethodCodec = StandardMethodCodec(BridgePigeonCodec());
    ...
    abstract class ObserveMainStateStreamHandler : PigeonEventChannelWrapper<MainModelStateData> {
        companion object {
            fun register(
                messenger: BinaryMessenger,
                streamHandler: ObserveMainStateStreamHandler,
                instanceName: String = ""
            ) {
                var channelName: String =
                    "dev.flutter.pigeon.pigeon_example_package.EventChannelBridge.observeMainState"
                if (instanceName.isNotEmpty()) {
                    channelName += ".$instanceName"
                }
                val internalStreamHandler = PigeonStreamHandler<MainModelStateData>(streamHandler)
                EventChannel(messenger, channelName, BridgePigeonMethodCodec).setStreamHandler(
            ...
            fun setUp(
                ...
                run {
                    val channel = BasicMessageChannel<Any?>(
                        binaryMessenger,
                        "dev.flutter.pigeon.pigeon_example_package.MainModelBridge.getState$separatedMessageChannelSuffix",
                        codec
                    )
                    if (api != null) {
                ...
                run {
                    val channel = BasicMessageChannel<Any?>(
                        binaryMessenger,
                        "dev.flutter.pigeon.pigeon_example_package.MainModelBridge.getEvent$separatedMessageChannelSuffix",
                        codec
                    )
                    if (api != null) {
                        channel.setMessageHandler { _, reply ->
                ...
                run {
                    val channel = BasicMessageChannel<Any?>(
                        binaryMessenger,
                        "dev.flutter.pigeon.pigeon_example_package.MainModelBridge.resetEvent$separatedMessageChannelSuffix",
                        codec
                    )
                    if (api != null) {
                        channel.setMessageHandler { _, reply ->
                ...
                run {
                    ...
                    val channel = BasicMessageChannel<Any?>(
                        binaryMessenger,
                        "dev.flutter.pigeon.pigeon_example_package.MainModelBridge.initState$separatedMessageChannelSuffix",
                        codec,
                        taskQueue
                    )
                    if (api != null) {
                ...
                run {
                    ...
                    val channel = BasicMessageChannel<Any?>(
                        binaryMessenger,
                        "dev.flutter.pigeon.pigeon_example_package.MainModelBridge.filterLanguage$separatedMessageChannelSuffix",
                        codec,
                        taskQueue
                    )
                    if (api != null) {
                ...
                run {
                    ...
                    val channel = BasicMessageChannel<Any?>(
                        binaryMessenger,
                        "dev.flutter.pigeon.pigeon_example_package.MainModelBridge.filterScope$separatedMessageChannelSuffix",
                        codec,
                        taskQueue
                    )
                    if (api != null) {
                ...
                run {
                    ...
                    val channel = BasicMessageChannel<Any?>(
                        binaryMessenger,
                        "dev.flutter.pigeon.pigeon_example_package.MainModelBridge.logOut$separatedMessageChannelSuffix",
                        codec,
                        taskQueue
                    )
                    if (api != null) {
        ...
        companion object {
            ...
            fun setUp(
                ...
                run {
                    val channel = BasicMessageChannel<Any?>(
                        binaryMessenger,
                        "dev.flutter.pigeon.pigeon_example_package.DetailModelBridge.getState$separatedMessageChannelSuffix",
                        codec
                    )
                    if (api != null) {
                        channel.setMessageHandler { _, reply ->
                ...
                run {
                    val channel = BasicMessageChannel<Any?>(
                        binaryMessenger,
                        "dev.flutter.pigeon.pigeon_example_package.DetailModelBridge.getEvent$separatedMessageChannelSuffix",
                        codec
                    )
                    if (api != null) {
                        channel.setMessageHandler { _, reply ->
                ...
                run {
                    val channel = BasicMessageChannel<Any?>(
                        binaryMessenger,
                        "dev.flutter.pigeon.pigeon_example_package.DetailModelBridge.resetEvent$separatedMessageChannelSuffix",
                        codec
                    )
                    if (api != null) {
                        channel.setMessageHandler { _, reply ->
                ...
                run {
                    val channel = BasicMessageChannel<Any?>(
                        binaryMessenger,
                        "dev.flutter.pigeon.pigeon_example_package.DetailModelBridge.load$separatedMessageChannelSuffix",
                        codec
                    )
                    if (api != null) {
                        channel.setMessageHandler { message, reply ->
                ...
                run {
                    val channel = BasicMessageChannel<Any?>(
                        binaryMessenger,
                        "dev.flutter.pigeon.pigeon_example_package.DetailModelBridge.like$separatedMessageChannelSuffix",
                        codec
                    )
                    if (api != null) {
                        channel.setMessageHandler { _, reply ->
                ...
                run {
                    val channel = BasicMessageChannel<Any?>(
                        binaryMessenger,
                        "dev.flutter.pigeon.pigeon_example_package.DetailModelBridge.dislike$separatedMessageChannelSuffix",
                        codec
                    )
                    if (api != null) {
                        channel.setMessageHandler { _, reply ->
                ...
                run {
                    val channel = BasicMessageChannel<Any?>(
                        binaryMessenger,
                        "dev.flutter.pigeon.pigeon_example_package.DetailModelBridge.save$separatedMessageChannelSuffix",
                        codec
                    )
                    if (api != null) {
                        channel.setMessageHandler { _, reply ->
                ...
                run {
                    val channel = BasicMessageChannel<Any?>(
                        binaryMessenger,
                        "dev.flutter.pigeon.pigeon_example_package.DetailModelBridge.copyToClipboard$separatedMessageChannelSuffix",
                        codec
                    )
                    if (api != null) {
                        channel.setMessageHandler { _, reply ->
                ...
                run {
                    val channel = BasicMessageChannel<Any?>(
                        binaryMessenger,
                        "dev.flutter.pigeon.pigeon_example_package.DetailModelBridge.share$separatedMessageChannelSuffix",
                        codec
                    )
                    if (api != null) {
                        channel.setMessageHandler { _, reply ->
                ...
                run {
                    val channel = BasicMessageChannel<Any?>(
                        binaryMessenger,
                        "dev.flutter.pigeon.pigeon_example_package.DetailModelBridge.delete$separatedMessageChannelSuffix",
                        codec
                    )
                    if (api != null) {
                        channel.setMessageHandler { _, reply ->
        ...
        companion object {
            ...
            fun setUp(
                ...
                run {
                    val channel = BasicMessageChannel<Any?>(
                        binaryMessenger,
                        "dev.flutter.pigeon.pigeon_example_package.LoginModelBridge.getState$separatedMessageChannelSuffix",
                        codec
                    )
                    if (api != null) {
                        channel.setMessageHandler { _, reply ->
                ...
                run {
                    val channel = BasicMessageChannel<Any?>(
                        binaryMessenger,
                        "dev.flutter.pigeon.pigeon_example_package.LoginModelBridge.getEvent$separatedMessageChannelSuffix",
                        codec
                    )
                    if (api != null) {
                        channel.setMessageHandler { _, reply ->
                ...
                run {
                    val channel = BasicMessageChannel<Any?>(
                        binaryMessenger,
                        "dev.flutter.pigeon.pigeon_example_package.LoginModelBridge.loginOrRegister$separatedMessageChannelSuffix",
                        codec
                    )
                    if (api != null) {
                        channel.setMessageHandler { message, reply ->
                ...
                run {
                    val channel = BasicMessageChannel<Any?>(
                        binaryMessenger,
                        "dev.flutter.pigeon.pigeon_example_package.LoginModelBridge.checkLoginState$separatedMessageChannelSuffix",
                        codec
                    )
                    if (api != null) {
                        channel.setMessageHandler { _, reply ->
                ...
                run {
                    val channel = BasicMessageChannel<Any?>(
                        binaryMessenger,
                        "dev.flutter.pigeon.pigeon_example_package.LoginModelBridge.resetEvent$separatedMessageChannelSuffix",
                        codec
                    )
                    if (api != null) {
                        channel.setMessageHandler { _, reply ->
